...
export class FilterService {
  ...
  // Prod
  // getPlanets() {
  //   this.applanetListtPlanets().subscribe(data => {
  //     this.planetList = [
  //       ...data[0]["results"],
  //       ...data[1]["results"],
  //       ...data[2]["results"],
  ...
  //     // } else planetListplanetList
  //     //   this.planetListSubject.next(this.planetList);
  //     // }
  //     if (this.filteredList) {
  //       this.filterSubject.next(JSON.stringify(this.filteredList));
  //     } else {
  //       this.filterSubject.next(JSON.stringify(this.planetList));
  //     }
  //   });
  // }
  ...
  // Dev
  getPlanets() {
    console.log(`FilterService getPlanets()`);
    const dataset = {
      count: 61,
